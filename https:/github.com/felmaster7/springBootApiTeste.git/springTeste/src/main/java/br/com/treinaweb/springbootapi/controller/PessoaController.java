...
public class PessoaController {
    ...
    @ApiOperation(value = "Adiciona uma pessoa a lista")
    ...
    @ApiOperation(value = "Edita uma pessoa da lista baseada no seu id")
    ...
    @ApiOperation(value = "Remove uma pessoa da lista baseada no seu id")
